...
{
  static const String ModelName = "model_recommended_creator_info";
  ...
  String toString()
  {
    return 'titleName : $titleName , creatorName : $creatorName , comicNumber : $comicNumber, userId : $userId , creatorId : $creatorId , url : $url';
  }
